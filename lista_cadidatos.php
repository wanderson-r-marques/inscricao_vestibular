...
CONCAT('https://palmares.saude.isolucoes.inf.br/',a.`laudo`) AS comprovante_deficianecia,
          ...
          <table class="table table-bordered table-condensed table-hover table-striped">
            ...
            <thead  class="thead-dark">
              <tr>
                ...
                <th>E-mail</th>
                <th>Comprovante da Deficiência</th>
            ...
            <tbody>
              ...
              foreach ($linhas as $linha) {  
                ...
                <tr>
                  ...
                  <td><?= $linha->email;  ?></td>
                  <!-- <td><?= $linha->comprovante_deficianecia;  ?></td> -->
                  <?php if ($linha->comprovante_deficianecia != '') : ?>
                       <td name="$linha->comprovante_deficianecia"><a target="_blank" href="<?= $linha->comprovante_deficianecia ?>"> Comprovante </a></td> 
                  <?php endif ?>
